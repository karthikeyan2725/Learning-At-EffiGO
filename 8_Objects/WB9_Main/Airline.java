        ...
        */
        while (true){
            if (people[index] != null){
                System.out.println("Dear, " + person.getName() + ", " + "Seat "+ index +" is reserved. Please choose some other seat.\n");
                person.chooseSeat();
                index = person.getSeatNumber() - 1; // since seat numbers can range from 1 - 11, whereas the index ranges from 0 - 10.
            } else{
                break;
            }
        }
